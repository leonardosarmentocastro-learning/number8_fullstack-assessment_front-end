export const Error = ({ error }: { error: JSON }) => (
  <div className='mt-[30%] flex flex-col text-center space-y-4 items-center justify-center'>
    <p className='text-[2.4rem] md:text-[3.2rem] text-[#fff] font-semibold'>Sorry, we had a technical problem.</p>
    <p className='text-[2rem] md:text-[2.4rem] text-[#98A1A8] font-regular'>More information below:</p>

    <pre className='p-12 inline-block whitespace-pre max-w-[100%] text-left overflow-x-scroll'>
      <code className='text-[1.2rem] md:text-[2rem] text-[#98A1A8] font-regular'>
